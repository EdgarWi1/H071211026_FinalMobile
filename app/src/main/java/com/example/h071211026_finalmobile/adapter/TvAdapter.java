...
public class TvAdapter extends RecyclerView.Adapter<TvAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TvAdapter.ViewHolder holder, int position) {
        ...
        Picasso.get().load("https://image.tmdb.org/t/p/w500"+tvResponseLists.get(position).getPosterPath()).into(holder.iv_item_image);
        holder.tv_item_title.setText(tvResponseLists.get(position).getTitle());
        holder.tv_item_year.setText(tvResponseLists.get(position).getReleaseDate());
